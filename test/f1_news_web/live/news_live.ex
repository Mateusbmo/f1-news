          ...
          <%= for n <- Enum.take(@news, 3) do %>
            <div class="swiper-slide">
              <div class="card w-full bg-base-100 shadow-xl">
                <figure>
                  <img src={n.image_url} alt={n.title} class="w-full h-64 object-cover rounded-t-lg" />
                </figure>
                <div class="card-body">
                  <h2 class="card-title text-xl"><%= n.title %></h2>
                  <p class="text-gray-600"><%= String.slice(n.content, 0, 100) %>...</p>
                  <div class="card-actions justify-end">
                    <a href={"/news/#{n.id}"} class="btn btn-primary">Read More</a>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <%= for n <- @news do %>
          <div class="card bg-base-100 shadow-md hover:shadow-lg transition-shadow">
            <figure>
              <img src={n.image_url} alt={n.title} class="w-full h-48 object-cover rounded-t-lg" />
            </figure>
            <div class="card-body">
