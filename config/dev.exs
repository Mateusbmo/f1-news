...
config :f1_news, F1NewsWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "sybGJB6cAjpA0nMUPbxU9/ysc7bg1krh1KpbG1PkUGYM3VafTi7T2s/hbJ8lVGM/",
  watchers: [
...
config :f1_news, F1NewsWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/f1_news_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]
